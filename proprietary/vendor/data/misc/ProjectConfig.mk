...
CUSTOM_BUILD_VERNO = CY-LC6-H617-C
...
#ITD: MODIFY camera porting by pengtao 20190117 start
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = constant_flashlight
CUSTOM_HAL_IMGSENSOR = gc8034main_mipi_raw s5k4h7yx_mipi_raw gc8034_mipi_raw gc8034mainb_mipi_raw s5k4h7yxpblc_mipi_raw gc8034b_mipi_raw
CUSTOM_TRAN_CAM_MATERIAL_CODE = gc8034_17201560 s5k4h7yx_17201561 gc8034_17201552
CUSTOM_HAL_LENS = dw9714af lc898212xdaf bu6424af ak7371af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS =
CUSTOM_HAL_MAIN_IMGSENSOR = gc8034main_mipi_raw s5k4h7yx_mipi_raw gc8034mainb_mipi_raw s5k4h7yxpblc_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9714af
CUSTOM_HAL_MSENSORLIB = akl akm
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS = ad5820af
CUSTOM_HAL_SUB_IMGSENSOR = gc8034_mipi_raw gc8034b_mipi_raw
CUSTOM_HAL_SUB_LENS = dummy_lens
TRAN_FLASH_SLIDE_CONTROL = yes
CUSTOM_SKIN_COLOR_COMPATIBLE = yes
#ITD:modify LCLGHLYQ-75  by yang.li3 20190307 start
TRAN_CAMERA_FLASHLIGHT_SCREEN_WITH_LED = yes
#ITD:modify LCLGHLYQ-75  by yang.li3 20190307 end
#ITD: MODIFY camera porting by pengtao 20190117 end
...
#BSP: add LCLGHLYQ-12 by xiaopan.ji for 20190115 start
CUSTOM_KERNEL_BAROMETER = no
#BSP: add LCLGHLYQ-12 by xiaopan.ji for 20190115 end
...
#ITD: MODIFY camera porting by pengtao 20190117 start
CUSTOM_KERNEL_IMGSENSOR = gc8034main_mipi_raw s5k4h7yx_mipi_raw gc8034_mipi_raw
#ITD: MODIFY camera porting by pengtao 20190117 end
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc8034main_mipi_raw s5k4h7yx_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9714af
#ITD: MODIFY camera porting by pengtao 20190117 end
CUSTOM_KERNEL_MOTION_DETECT =
#BSP: modify LCLGHLYQ-65  by xiaopan.ji 20190220 start
CUSTOM_KERNEL_ORIENTATION_SENSOR = no
#BSP: modify LCLGHLYQ-65  by xiaopan.ji 20190220 end
...
#TSD: Modify LCLGHLYQ-2 by yong.chen1 20190116 start
CUSTOM_MODEM = lc6_h617_c1
#TSD: Modify LCLGHLYQ-2 by yong.chen1 20190116 end
...
#BSP: modify HLESPUB-3526 by baihaiping 20190116 start
MTK_AUDIO_NUMBER_OF_MIC = 1
#BSP: modify HLESPUB-3526 by baihaiping 20190116 end
...
#modify by hanfeng.wang for build version  20190102 start
MTK_BUILD_VERNO=LC6-H617CDE-PGo-190802V245
FINGERPRINT_BUILD_VERNO=CDE-190802V245
#modify by hanfeng.wang for build version  20190102 end
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
#BSP:add LCLGHLYQ-5 by yongqing.dou 20190114 start
MTK_DUAL_CHARGER_SUPPORT = no
#BSP:add LCLGHLYQ-5 by yongqing.dou 20190114 end
...
#TSD: modify LCLGHLYQ-40 by jiangerji 20190123 start
MTK_ETWS_SUPPORT = yes
#TSD: modify LCLGHLYQ-40 by jiangerji 20190123 end
...
#BSP:modify LCLGHLYQ-15 by wang.qin 20190116 start
MTK_FACTORY_MODE_IN_GB2312 = no
#BSP:modify LCLGHLYQ-15 by wang.qin 20190116 end
...
MTK_FIRST_MD = 1
#TSD: Modify LCLGHLYQ-2 by yong.chen1 20190117 start
MTK_FLIGHT_MODE_POWER_OFF_MD = yes
#TSD: Modify LCLGHLYQ-2 by yong.chen1 20190117 end
MTK_FLIGHT_MODE_POWER_OFF_MD_POLICY = 0
MTK_FLV_PLAYBACK_SUPPORT = yes
#TSD:Modify LCLGHLYQ-20 by huijun.shen 20190117 start
MTK_FMRADIO_APP = yes
#TSD:Modify LCLGHLYQ-20 by huijun.shen 20190117 end
MTK_FM_50KHZ_SUPPORT = no
MTK_FM_CHIP = MT6631_FM
MTK_FM_RX_AUDIO = FM_DIGITAL_INPUT
MTK_FM_RX_SUPPORT = yes
#BSP:modify LCLGHLYQ-51 baihaiping 20190128 start
MTK_FM_SHORT_ANTENNA_SUPPORT = yes
#BSP:modify LCLGHLYQ-51 baihaiping 20190128 end
#TSD:Modify LCLGHLYQ-20 by huijun.shen 20190117 start
MTK_FM_SUPPORT = yes
#TSD:Modify LCLGHLYQ-20 by huijun.shen 20190117 end
...
#SID1: modified KBEHHLYS-8 by shenjiang.he 18.11.30 start
MTK_LIVEWALLPAPER_APP = no
#SID1: modified KBEHHLYS-8 by shenjiang.he 18.11.30 end
...
#TSD:Modify LCLGHLYQ-960 to open dual IMS by yong.chen1 20190327 start
MTK_MULTIPLE_IMS_SUPPORT = 2
#TSD:Modify LCLGHLYQ-960 to open dual IMS by yong.chen1 20190327 end
...
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
#BSP: add LCLGHLYQ-1 by kun.liu 20190111 start
MTK_UART_USB_SWITCH = yes
#BSP: add LCLGHLYQ-1 by kun.liu 20190111 end
MTK_UCE_SUPPORT = no
MTK_UFS_BOOTING = no
MTK_UFS_OTP = no
...
#TSD: modify LCLGHLYQ-88 by chengsheng.zhao 20190225 start
MTK_WFD_SUPPORT = yes
#TSD: modify LCLGHLYQ-88 by chengsheng.zhao 20190225 end
...
#TCD:modify LCLGHLYQ-321 by xulongyan 2019.2.28 start
MTK_WMA_PLAYBACK_SUPPORT = no
#TCD:modify LCLGHLYQ-321 by xulongyan 2019.2.28 end
...
#BSP: add LCLGHLYQ-19 by wang.qin 20190117 start
...
#BSP: add LCLGHLYQ-19 by wang.qin 20190117 end
#PPD: add LCLGHLYQ-38 by shuaishuai.ren 20190124 start
include $(LOCAL_PATH)/ProjectConfig_PPD.mk
#PPD: add LCLGHLYQ-38 by shuaishuai.ren 20190124 end
#BSP: add XWWYLHLYS-41 by ka.fang 20180930 start
TRAN_SYSTEM_DEVINFO=yes
#BSP: add XWWYLHLYS-41 by ka.fang 20180930 end
#BSP: add custom macro by wanghanfeng 20181228 start
CUSTOM_TRAN_PROJECT=tran_lc6
CUSTOM_TRAN_BOM=tran_lc6_c1
#BSP: add custom macro by wanghanfeng 20181228 end
#[BSP]add XLELHLES-11 by qiaoqiao.pan on 20190114 start
TRAN_FINGERPRINT_SUPPORT = sunwave_tee
#[BSP]add XLELHLES-11 by qiaoqiao.pan on 20190114 end
#BSP:add LCLGHLYQ-54 by yongqing.dou 20190212 start
TRAN_LED_BLUE_SUPPORT = yes
TRAN_DUAL_LINEAR_CHARGER = yes
#BSP:add LCLGHLYQ-54 by yongqing.dou 20190212 end
#BSP:add LCLGHLYQ-4 by shiyu.xu 20190121 start
TRAN_LCM_SUPPORT = yes
#BSP:add LCLGHLYQ-4 by shiyu.xu 20190121 end

#BSP:add LCLGHLYQ-33 by suwen.huang 20190122 start
TRAN_TP_SUPPORT = yes
#BSP:add LCLGHLYQ-33 by suwen.huang 20190122 end
#ITD:modify LCLGHLYQ-828  by yang.li3 20190320 start
TRAN_CAMERA_FLASHLIGHT_SCREEN_WITH_LED = yes
#ITD:modify LCLGHLYQ-828  by yang.li3 20190320 end
#[ITD]add cam 3pty function XWWYLHLYS-302 by yu.wang 20190215 start
TRAN_CAMERA_FEATURE = yes
#[ITD]add cam 3pty function XWWYLHLYS-302 by yu.wang 20190215 end

#[ITD] add for tran camera thirdpart by zhoumw 20190402 start
TRAN_CAMERA_THIRDPART = yes
#[ITD] add for tran camera thirdpart by zhoumw 20190402 start

#modify XLLSHLSSP-17 by shentao.yang enable cache persist tranfs tkv WP f2fs for lc6 20190114 start
TRAN_TKV_SUPPORTED=yes
#ITD:modify RABHLYSP-11 by quan.chang 181127 start
CUSTOM_TRAN_PCBA = tran_pcba_h617
#ITD:modify RABHLYSP-11 by quan.chang 181127 end
TRAN_USE_F2FS = yes
#modify XLLSHLSSP-17 by shentao.yang enable cache persist tranfs tkv WP f2fs for lc6 20190114 end
#BSP:add LCLGHLYQ-15 by wang.qin 20190116 start
TRAN_SYSTEM_DEVINFO=yes
#BSP:add LCLGHLYQ-15 by wang.qin 20190116 end

#SID1: add KBEHLYS-9 by shenjiang.he 18.08.30 start
include $(LOCAL_PATH)/ProjectConfig_SID.mk
#SID1: add KBEHLYS-9 by shenjiang.he 18.08.30 end

#TDD:add LCLGHLYQ-30 by qi.jiang 20190121 start
include $(LOCAL_PATH)/ProjectConfig_TDD.mk
#TDD:add LCLGHLYQ-30 by qi.jiang 20190121 end
#BSP:add LCLGHLYQ-51 baihaiping 20190128 start
TRAN_SHORT_ANTENNA_SUPPORT=yes
#BSP:add LCLGHLYQ-51 baihaiping 20190128 end

#APP:add by yuanyuan.guo 20190216 start
include $(LOCAL_PATH)/ProjectConfig_APP.mk
#APP:add by yuanyuan.guo 20190216 end
